...
const UserProfile = () => {
  ...
  useEffect(() => {
    const getUserData = JSON.parse(localStorage.getItem("user-log"))

    console.log(getUserData.data.data);

    setInfo(getUserData.data.data)
  }, [])
  ...
  const finalUpdate = () => {
    dispatch({ type: UPDATE_USER_PROGRESS, payload: userInfo })
      ...
      <div className="profile bg-[#1e293b] w-full h-[100vh]" style={{ display: hideMain }}>
        ...
        <div className="profile-info text-white flex flex-col items-center">
          <div className="profile-img sm:w-[60%] w-[75%] h-[10%] flex justify-start my-5">
            <img src={userInfo.Profile} alt="profile-img" className="w-[20%] rounded-full" />
          </div>
          <div className="info grid grid-cols-2 sm:w-[60%] w-[75%] gap-4 text-start text-[12px] sm:text-[14px] md:text-[16px]">
            ...
            <div className="dob  font-extralight">
              Date Of Birth
              <div className="font-bold">{userInfo.DOB}</div>
            </div>
            <div className="phone  font-extralight">
              Phone Number
              <div className="font-bold">{userInfo.Phone}</div>
            </div>
            <div className="address  font-extralight">
              Address
              <div className="font-bold">{userInfo.Address}</div>
            </div>
            <div className="role  font-extralight">
              Role
              <div className="font-bold">{userInfo.Role}</div>
            </div>
            <div className="cardNumber  font-extralight">
              Card Number
              <div className="font-bold">{userInfo.CardNumber}</div>
            </div>
          </div>
            ...
            <div className="login-field w-full h-[100vh] flex flex-col justify-center items-center">
              <div className="input-field border-2 border-color: rgb(29 78 216);  p-5  sm:w-[50%] w-[80%] sm:p-5 my-16 sm:text-[16px] text-[12px] rounded-md sm:m-[0] ">
                ...
                <div className="image flex justify-center">
                  <img src={userInfo.Profile} alt="profile-img" className=" rounded-full my-2 w-[80px]" />
                </div>
                <div>
                  <label htmlFor='voterId' className="font-semibold mb-[10px] ml-2">Profile Image Link</label>
                  <br />
                  <input type="text" className="border-2 border-color: rgb(29 78 216); rounded-md mb-[5px] w-[100%] m-[5px] p-1" value={userInfo.Profile} onChange={(e) => handleChange(e)} name="Profile" />
                </div>
                <div>
                  <label htmlFor='voterId' className="font-semibold mb-[10px] ml-2">Name</label>
                  <br />
                  <input type="text" className="border-2 border-color: rgb(29 78 216); rounded-md mb-[5px] w-[100%] m-[5px] p-1" value={userInfo.Name} onChange={(e) => handleChange(e)} name="Name" />
                </div>
                <div>
                  <label htmlFor='voterId' className="font-semibold mb-[10px] ml-2">Card Number</label>
                  <br />
                  <input type="text" className="border-2 border-color: rgb(29 78 216); rounded-md mb-[5px] w-[100%] m-[5px] p-1" value={userInfo.CardNumber} onChange={(e) => handleChange(e)} name="CardNumber" />
                </div>
                <div>
                  <label htmlFor='voterId' className="font-semibold mb-[10px] ml-2">DOB</label>
                  <br />
                  <input type="text" className="border-2 border-color: rgb(29 78 216); rounded-md mb-[5px] w-[100%] m-[5px] p-1" value={userInfo.DOB} onChange={(e) => handleChange(e)} name="DOB" />
                </div>
                <div>
                  <label htmlFor='voterId' className="font-semibold mb-[10px] ml-2">Phone</label>
                  <br />
                  <input type="text" className="border-2 border-color: rgb(29 78 216); rounded-md mb-[5px] w-[100%] m-[5px] p-1" value={userInfo.Phone} onChange={(e) => handleChange(e)} name="Phone" />
                </div>
                <div>
                  <label htmlFor='voterId' className="font-semibold mb-[10px] ml-2">Email</label>
                  <br />
                  <input type="text" className="border-2 border-color: rgb(29 78 216); rounded-md mb-[5px] w-[100%] m-[5px] p-1" value={userInfo.Email} onChange={(e) => handleChange(e)} name="Email" />
                </div>
                <div>
                  <label htmlFor='voterId' className="font-semibold mb-[10px] ml-2">Address</label>
                  <br />
                  <input type="text" className="border-2 border-color: rgb(29 78 216); rounded-md mb-[5px] w-[100%] m-[5px] p-1" value={userInfo.Address} onChange={(e) => handleChange(e)} name="Address" />
                </div>
